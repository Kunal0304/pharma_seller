...
// add jobs
export const addNewGroupList = group => post(url.BASE_URL+url.ADD_SELLER_GROUP, group);

export const updateGroup = group => post(url.BASE_URL+url.UPDATE_SELLER_GROUP, group);
...
export const updateMember = member => post(url.BASE_URL+url.UPDATE_SELLER_MEMBERS, member);

export const updateMemberStatus = member => post(url.BASE_URL+url.UPDATE_SELLER_MEMBERS_STATUS, member);
