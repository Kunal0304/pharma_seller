...
import OrderMedical from "../pages/OrdersMedical";
import OrderDetails from "../pages/OrdersMedical/orderDetails";
import TicketsMedical from "../pages/TicketsMedical";
import TicketDetails from "../pages/TicketsMedical/ticketDetails";
import InventryMedicel from "../pages/InventryMedicel";
import SettlementMedical from "../pages/SettlementMedical";
import StaffMedical from "../pages/StaffMedical";
import GroupMedical from "../pages/GroupMedical";
import ProductRequestsMedical from "../pages/ProductRequestsMedical";
import ComplianceMedical from "../pages/ComplianceMedical";

//   { path: "/dashboard", component: <Dashboard /> },
const authProtectedRoutes = [
  { path: "/dashboard", component: <DashboardMedical /> },
  { path: "/orders", component: <OrderMedical /> },
  { path: "/orders/:id", component: <OrderDetails /> },
  { path: "/tickets", component: <TicketsMedical /> },
  { path: "/tickets/:id", component: <TicketDetails /> },
  { path: "/inventry", component: <InventryMedicel /> },
  { path: "/settelement", component: <SettlementMedical /> },
  { path: "/group", component: <GroupMedical /> },
  { path: "/productrequest", component: <ProductRequestsMedical /> },
  { path: "/staff", component: <StaffMedical /> },
  { path: "/complaince-form", component: <ComplianceMedical /> },
