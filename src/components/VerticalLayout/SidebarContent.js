...
import {
  getShopVacation, setShopVacation
} from "store/actions";
//i18n
      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            <li className="menu-title">{props.t("Final")} </li>
            <li>
              <Link to="/dashboard" >
            ...
            {/* <li className="menu-title">{props.t("Reference")} </li>
            <li>
